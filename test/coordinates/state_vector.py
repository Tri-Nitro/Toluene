...
itrf_test_points = [
    ...
    StateVector(-2706181.6267071473, -4261070.165026739, 3885735.290996956,
                ...
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # San Francisco, USA
    StateVector(-2317914.5038877944, 5391355.734786994, 2489875.9948529475,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Guangzhou, China
    StateVector(1334000.5446860846, -4654052.12920688, 4138306.7613726556,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # New York City, USA
    StateVector(-3954869.0631549605, 3354957.9490679787, 3700288.1237203646,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Tokyo, Japan
    StateVector(1335650.794194833, 6072159.400646209, 1422550.1687721466,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Bangalore, India
    StateVector(1468225.3552191756, 5238677.546124002, 3318097.9233186147,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Lahore, Pakistan
    StateVector(196696.71042015063, -4752114.554500811, 4235653.749994335,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Chicago, USA
    StateVector(-3044790.9362076046, 4043803.6753922133, 3867430.9995572227,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Seoul, South Korea
    StateVector(1240621.3815494243, 5464588.4359043995, 3036507.895895077,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Delhi, India
    StateVector(4787489.766778159, 181272.54855436122, 4196330.517202016,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Barcelona, Spain
    StateVector(-2503385.149590922, -4660255.25606549, 3551285.115595811,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Los Angeles, USA
    StateVector(-1270629.2090853488, -5706546.240194934, 2541250.16991839,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # León, Mexico
    StateVector(3978016.0582352793, -8873.10199269117, 4968902.331366097,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # London, UK
    StateVector(3590949.0583496066, 4517677.680034685, 2706845.7276584287,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Doha, Qatar
    StateVector(-1129388.4875065808, 6092566.778459311, 1506806.8879319832,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Bangkok, Thailand
    StateVector(4853180.057032302, -314164.29855723435, 4113762.729820025,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Madrid, Spain
    StateVector(-42033.56664680122, 5838313.591165916, 2559076.8097958085,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Dhaka, Bangladesh
    StateVector(4641602.244591051, 1028712.4738301872, 4237588.573991904,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Rome, Italy
    StateVector(-2410004.3232879606, 5385236.433369752, 2415055.9083167086,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Hong Kong, SAR China
    StateVector(-3178140.633423443, 5292619.680537387, 1597260.3694744613,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Manila, Philippines
    StateVector(3941265.3098854595, 727020.0670461959, 4945212.867743558,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Berlin, Germany
    StateVector(2849538.5273332233, 2195834.844004245, 5249318.407671388,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Moscow, Russia
    StateVector(4200937.804351269, 172560.72143258236, 4780107.699250289,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Paris, France
    StateVector(-2745687.8140138057, 4696667.817791838, 3317988.5665823524,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Suzhou, China
    StateVector(3573638.2482950804, -199065.37437001418, 5261571.8192865485,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Edinburgh, UK
    StateVector(1335651.8613013579, 6072164.251944874, 1422528.6042099572,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Bengaluru, India
    StateVector(1107694.2065800726, -4345435.687023454, 4520399.686263348,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Ottawa, Canada
    StateVector(-2452102.125403971, -4779253.208882448, 3427484.159740133,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # San Diego, USA
    StateVector(-888769.5164506885, -5091475.299490853, 3725676.658934424,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Abilene, USA
    StateVector(1532149.2696453626, -4464588.77258648, 4275273.369866783,
                time=datetime(2023, 11, 20, 0, 0, 0, tzinfo=timezone.utc).timestamp(),
                frame=ReferenceFrame.InternationalTerrestrialReferenceFrame),  # Boston, USA
]
...
class TestStateVectorTransform:
    ...
    def test_itrf_to_gcrf_to_itrf(self):
        ...
        for idx in range(len(itrf_test_points)):
            ...
            assert itrf_point is not None
            print("Position", itrf_point.position, itrf_test_points[idx].position)
            ...
            print("Velocity", itrf_point.velocity, itrf_test_points[idx].velocity)
            assert itrf_point.velocity[0] == pytest.approx(itrf_test_points[idx].velocity[0], abs=3)
            assert itrf_point.velocity[1] == pytest.approx(itrf_test_points[idx].velocity[1], abs=3)
            assert itrf_point.velocity[2] == pytest.approx(itrf_test_points[idx].velocity[2], abs=3)
            print("Acceleration", itrf_point.acceleration, itrf_test_points[idx].acceleration)
