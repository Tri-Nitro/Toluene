...
egm84_height(PyObject *self, PyObject *args) {
    ...
    if (strcmp(interpolation_method, "bilinear") == 0) {
        ...
        h = bilinear_interpolation(latitude, longitude, four_corners);
    } else {
...
static PyMethodDef tolueneCoreMethods[] = {
    ...
    {"egm84_height", egm84_height, METH_VARARGS, "Calculate the height of the geoid at a given latitude and longitude."},
